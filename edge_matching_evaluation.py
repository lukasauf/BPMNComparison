...
"""
This script evaluates edge matching in BPMN models using three different low-level approaches:
...
Functions:
    run_matching(weights, threshold):
        Runs the edge matching for the PET dataset list of BPMN models using the specified weights
        and threshold.
...
def run_em_evaluation():
    ...
    if input_user == 'S':
        print('\n\033[1mEvaluation of edge matching with syntactic similarity\033[0m\n')
        run_matching(weights_syntactic, threshold_syntactic)
    elif input_user == 'B':
        print('\n\033[1mEvaluation of edge matching with BERT similarity\033[0m\n')
        run_matching(weights_bert, threshold_bert)
    elif input_user == 'G':
        print('\n\033[1mEvaluation of edge matching with GloVe similarity\n\033[0m')
